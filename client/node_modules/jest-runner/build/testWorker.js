'use strict';
/* build-hook-start *//*00001*/try { require('/Users/theodiamant/.vscode/extensions/wallabyjs.console-ninja-1.0.428/out/buildHook/index.js').default({tool: 'jest', checkSum: '2035f0e3d8c16d2bd74457AQJIBUsCXl4GBlJSBlZXAVYBVwMD', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/theodiamant/.vscode/extensions/wallabyjs.console-ninja-1.0.428/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '2035f0e3d8c16d2bd74457AQJIBUsCXl4GBlJSBlZXAVYBVwMD', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
